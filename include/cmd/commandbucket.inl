...
template <typename Key>
void CommandBucket<Key>::Merge(size_t *scratch_list, size_t index_left, size_t index_right, size_t end_index)
{
	memcpy(&scratch_list[index_left], &m_sorted_indices[index_left], sizeof(size_t)*(end_index-index_left+1));
